...
<?php 
 ...
 <div class="row">
 	<div class="col-md-4">
 		...
 		Total : IDR <?php echo number_format($detail['total_pembelian']); ?><br>
 	...
 	<div class="col-md-4">
 		...
 		Ongkir : IDR <?php echo number_format($detail['tarif']); ?><br>
 ...
 <table class="table table-bordered">
 	...
 	<tbody>
 		...
 		<tr>
 			...
 			<td>IDR <?php echo number_format($pecah['harga_produk']*$pecah['jumlah']); ?></td>
 		</tr>
 		<?php $nomor++; ?>
 	<?php endwhile; ?>
 	</tbody>
